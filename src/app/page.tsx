...
export default function NetAuditDashboard() {
  ...
  const exportJson = useCallback(async () => {
    ...
    a.href = url
    a.download = `netaudit-report-${scanResult.timestamp.split('T')[0]}.json`
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                <div className="relative p-3 bg-gradient-to-br from-red-500 to-red-600 rounded-xl shadow-lg shadow-red-500/25">
                  <Shield className="h-7 w-7 text-white" />
                </div>
              </div>
              <div>
                <h1 className="text-2xl font-bold tracking-tight bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 bg-clip-text text-transparent">
                  CRYPTSK NetAudit
                </h1>
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between text-sm text-slate-500">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-slate-700">CRYPTSK NetAudit</span>
